...
const TitleOfMainMovie = ({title, overview}) => {
    return (
        <div className="w-screen h-screen overflow-hidden absolute px-20 pt-[28%] text-white bg-gradient-to-r from-black bg-opacity-50 z-10">
            ...
            <div className="space-x-3">
                ...
                <button className="px-4 py-2 bg-gray-500 text-black font-semibold rounded-md hover:bg-gray-400 cursor-pointer">More Info</button>
            </div>
        </div>
    );
}
